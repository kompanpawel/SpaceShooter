...
public class HelpScreen implements Screen {
    ...
    public void show() {
        ...
        Label pause = new Label("To pause game press ESC, to unpause, press ESC again(warning, unpause at least 3 sec after pausing, temporary instability)", game.assetManager.get("fonts_and_others/uiskin.json", Skin.class));
        Label save = new Label("Saving/loading game", game.assetManager.get("fonts_and_others/uiskin.json", Skin.class));
        Label saveText = new Label("//TODO", game.assetManager.get("fonts_and_others/uiskin.json", Skin.class));
        //table.debug();
